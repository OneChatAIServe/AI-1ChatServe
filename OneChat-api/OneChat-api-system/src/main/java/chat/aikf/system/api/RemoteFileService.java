...
import chat.aikf.system.api.factory.RemoteFileFallbackFactory;
 ...
 * @author ruoyi
 */
@FeignClient(contextId = "remoteFileService", value = ServiceNameConstants.OneChatFile, fallbackFactory = RemoteFileFallbackFactory.class)
